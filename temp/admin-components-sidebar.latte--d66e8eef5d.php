...
final class Template_d66e8eef5d extends Latte\Runtime\Template
{
    ...
    <ul>
		...
		echo '/';
		echo LR\Filters::escapeHtmlAttr($prefix_admin) /* line 12 */;
		echo '/editor">
		...
		echo '/';
		echo LR\Filters::escapeHtmlAttr($prefix_admin) /* line 16 */;
		echo '/users">
		...
		echo '/';
		echo LR\Filters::escapeHtmlAttr($prefix_admin) /* line 21 */;
		echo '/pengaturan">
